...
def main_loop():
    ...
    messages = [
        ...
        Story_messages('images/s011.png', 'images/p010.png', 1200, 600,
                       "Полночь наступила, и вместе с ней пришел ужасный шторм. Молнии сверкали на небе, озаряя мрачные тучи, а раскаты грома раздавались так громко, что земля казалась дрожащей от их мощи. Ветер свистел и ревел, словно зверь, готовый покинуть цепи своего укромного убежища."),
        Story_messages('images/s012-1.png', 'images/p008.png', 600, 500,
                       " Лиз, напуганная этой стихией, беспокойно бродила по коридорам маяка, ища Алекса. В конце концов, она нашла его в глубине маяка, около запечатанной двери, которую он открыл ранее."),
        Story_messages('images/s012-1.png', 'images/p008.png', 600, 500,
                       "Лиз:  Алекс! Мы должны найти безопасное место, эта буря становится все сильнее! "),
        Story_messages('images/s012-1.png', 'images/p001.png', -500, 500,
                       "Алекс:  Да, ты права. Нам нужно найти укрытие. Но я нашел что-то невероятное, Лиз. Этот свиток содержит ключ к защите маяка от этой бури. "),
        Story_messages('images/s012-1.png', 'images/p001.png', -500, 500,
                       "Лиз: Как это возможно? Нам нужно думать о своей безопасности, Алекс. Не может быть, чтобы древний свиток спас нас от этой бури! "),
        Story_messages('images/s012-1.png', 'images/p001.png', -500, 500,
                       "Лиз:  Алекс. Но я чувствую, что проводить обряд в эту ночь под такой бурей — это слишком опасно. Давай найдем укрытие и дождемся утра. Мы сможем выполнить обряд, когда шторм утихнет. "),
        Story_messages('images/s012-1.png', 'images/p001.png', -500, 500,
                       "Алекс: (соглашается) Ты права, Лиз. Нам нужно думать о нашей безопасности. Давай поищем безопасное место и подождем утра, чтобы провести обряд."),
        Story_messages('images/s012-3.png', 'images/p010.png', 600, 500,
                       "Алекс: (соглашается) Ты права, Лиз. Нам нужно думать о нашей безопасности. Давай поищем безопасное место и подождем утра, чтобы провести обряд."),
        Story_messages('images/s005.png', 'images/p008.png', 600, 500,
                       "Утро. шторм утих.Алекс и Лиз вернулись в Хейвенбрук."),
        Story_messages('images/s004.png', 'images/p001.png', -500, 100,
                       "Алекс отправился в кафе Морской Бриз "),
        Story_messages('images/s004.png', 'images/p004.png', 600, 400,
                       " **Алекс**: Расскажите, какие странные вещи происходили здесь с маяком "),
        Story_messages('images/s004.png', 'images/p004.png', -500, 100,
                       "Ох, молодой человек, маяк этот... Он всегда был загадкой. Старые говорят, что там духи охраняют море"),
        Story_messages('images/s004.png', 'images/p004.png', 600, 400,
                       "Мой дед всегда говорил, что маяк светится даже когда выключен. Говорят, там есть скрытая комната."),
        Story_messages('images/s004.png', 'images/p001.png', -500, 100,
                       "Скрытая комната? Это весьма интересно. Вы не знаете, где она может быть?"),
        Story_messages('images/s004.png', 'images/p004.png', 600, 400,
                       " Ответа не последовало..."),
        Story_messages('images/s004.png', 'images/p001.png', -500, 100,
                       " Алекс записывает все собранные данные и решает посетить архив местной библиотеки"),
        Story_messages('images/s014.png', 'images/p001.png', -500, 100,
                       "  Библиотека Хейвенбрука — тихое место с высокими полками, наполненными пыльными книгами и старыми газетами"),
        Story_messages('images/s014.png', 'images/p001.png', -500, 100,
                       " Алекс : Вот это интересно. 'Необъяснимые явления у маяка в 1894 году'... Нужно узнать больше"),
        Story_messages('images/s014.png', 'images/p009.png', 700, 400,
                       "Библиотекарь :Нашли что-нибудь полезное? "),
        Story_messages('images/s014.png', 'images/p001.png', -500, 100,
                       " Алекс :Да, кажется, что маяк всегда был окружён мистикой. Есть ли у вас материалы, которые могут помочь мне глубже понять историю маяка?"),
        Story_messages('images/s014.png', 'images/p009.png', 700, 400,
                       "Библиотекарь :Вы могли бы пообщаться с мистером Эдвардсом, нашим местным историком. Он знает об этом месте практически всё "),
